...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/sound_trigger_mixer_paths_lagoonqrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_pathslagoonqrd.xml \
...
$(call inherit-product, device/oneplus/sm7225-common/common.mk)
